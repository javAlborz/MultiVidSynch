...
def construct_trajectories(matches, keypoints1, keypoints2, existing_trajectories=None, match_map=None):
    ...
    for match in matches:
        ...
        if match.queryIdx in match_map:
            ...
            # Append the new keypoint to the corresponding trajectory
...
def main():
    ...
    first_frames_descriptors = []  # To hold the descriptors of the first frame of each videoq
